...
export const GEAR_SETS: GearSet[] = [
  ...
  },
  {
    ...
    icon: `${CDN}/itemicon/item_equip_t4_suit_atb01_body_01.png`,
    pieces: [
      { id: nextId(), name: 'Frontiers Armor T2', setName: 'Frontiers', tier: 'T4', level: 70, def: 56, stats: [{ name: 'Agility', value: '+87' }, { name: 'Intellect', value: '+58' }, { name: 'Normal Skill DMG', value: '+20.7%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_atb01_body_01.png` },
      { id: nextId(), name: 'Frontiers Comm', setName: 'Frontiers', tier: 'T4', level: 70, def: 21, stats: [{ name: 'Strength', value: '+32' }, { name: 'Agility', value: '+21' }, { name: 'Combo Skill DMG', value: '+41.4%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_atb01_edc_01.png` },
      { id: nextId(), name: 'Frontiers Comm T1', setName: 'Frontiers', tier: 'T4', level: 70, def: 21, stats: [{ name: 'Strength', value: '+32' }, { name: 'Intellect', value: '+21' }, { name: 'Cryo & Electric DMG', value: '+23.0%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_atb01_edc_02.png` },
      { id: nextId(), name: 'Frontiers Extra O2 Tube', setName: 'Frontiers', tier: 'T4', level: 70, def: 21, stats: [{ name: 'Agility', value: '+32' }, { name: 'Intellect', value: '+21' }, { name: 'Sub-Attr', value: '+20.7%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_atb01_edc_03.png` },
      { id: nextId(), name: 'Frontiers Armor T3', setName: 'Frontiers', tier: 'T4', level: 70, def: 56, stats: [{ name: 'Agility', value: '+87' }, { name: 'Intellect', value: '+58' }, { name: 'Sub-Attr', value: '+10.4%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_atb01_body_02.png` },
      { id: nextId(), name: 'Frontiers Armor T1', setName: 'Frontiers', tier: 'T4', level: 70, def: 56, stats: [{ name: 'Strength', value: '+87' }, { name: 'Agility', value: '+58' }, { name: 'Normal Skill DMG', value: '+20.7%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_atb01_body_03.png` },
      { id: nextId(), name: 'Frontiers Armor', setName: 'Frontiers', tier: 'T4', level: 70, def: 56, stats: [{ name: 'Strength', value: '+87' }, { name: 'Intellect', value: '+58' }, { name: 'Ultimate DMG', value: '+25.9%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_atb01_body_04.png` },
      { id: nextId(), name: 'Frontiers Blight RES Gloves', setName: 'Frontiers', tier: 'T4', level: 70, def: 42, stats: [{ name: 'Agility', value: '+65' }, { name: 'Intellect', value: '+43' }, { name: 'Normal Skill DMG', value: '+34.5%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_atb01_hand_01.png` },
    ],
  },
  {
    name: 'Hot Work',
  ...
  },
  {
    ...
    icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_body_01.png`,
    pieces: [
      { id: nextId(), name: 'MI Security Overalls', setName: 'MI Security', tier: 'T4', level: 70, def: 56, stats: [{ name: 'Intellect', value: '+87' }, { name: 'Agility', value: '+58' }, { name: 'Normal ATK DMG', value: '+13.8%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_body_01.png` },
      { id: nextId(), name: 'MI Security Armor', setName: 'MI Security', tier: 'T4', level: 70, def: 56, stats: [{ name: 'Agility', value: '+87' }, { name: 'Strength', value: '+58' }, { name: 'Arts Intensity', value: '+21' }], icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_body_02.png` },
      { id: nextId(), name: 'MI Security Scope', setName: 'MI Security', tier: 'T4', level: 70, def: 21, stats: [{ name: 'Agility', value: '+32' }, { name: 'Strength', value: '+21' }, { name: 'Normal Skill DMG', value: '+41.4%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_edc_01.png` },
      { id: nextId(), name: 'MI Security Toolkit', setName: 'MI Security', tier: 'T4', level: 70, def: 21, stats: [{ name: 'Intellect', value: '+32' }, { name: 'Agility', value: '+21' }, { name: 'Crit Rate', value: '+10.3%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_edc_02.png` },
      { id: nextId(), name: 'MI Security Armband', setName: 'MI Security', tier: 'T4', level: 70, def: 21, stats: [{ name: 'Strength', value: '+32' }, { name: 'Will', value: '+21' }, { name: 'Cryo & Electric DMG', value: '+23.0%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_edc_03.png` },
      { id: nextId(), name: 'MI Security Push Knife', setName: 'MI Security', tier: 'T4', level: 70, def: 21, stats: [{ name: 'Will', value: '+32' }, { name: 'Intellect', value: '+21' }, { name: 'Heat & Nature DMG', value: '+23.0%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_edc_04.png` },
      { id: nextId(), name: 'MI Security Push Knife T1', setName: 'MI Security', tier: 'T4', level: 70, def: 21, stats: [{ name: 'Will', value: '+32' }, { name: 'Agility', value: '+21' }, { name: 'Normal Skill DMG', value: '+41.4%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_edc_05.png` },
      { id: nextId(), name: 'MI Security Hands PPE', setName: 'MI Security', tier: 'T4', level: 70, def: 42, stats: [{ name: 'Intellect', value: '+65' }, { name: 'Agility', value: '+43' }, { name: 'Normal ATK DMG', value: '+23.0%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_hand_01.png` },
      { id: nextId(), name: 'MI Security Overalls T2', setName: 'MI Security', tier: 'T4', level: 70, def: 56, stats: [{ name: 'Will', value: '+87' }, { name: 'Agility', value: '+58' }, { name: 'Normal Skill DMG', value: '+20.7%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_body_03.png` },
      { id: nextId(), name: 'MI Security Hands PPE T1', setName: 'MI Security', tier: 'T4', level: 70, def: 42, stats: [{ name: 'Intellect', value: '+65' }, { name: 'Will', value: '+43' }, { name: 'Crit Rate', value: '+8.6%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_hand_02.png` },
      { id: nextId(), name: 'MI Security Gloves', setName: 'MI Security', tier: 'T4', level: 70, def: 42, stats: [{ name: 'Agility', value: '+65' }, { name: 'Strength', value: '+43' }, { name: 'Normal Skill DMG', value: '+34.5%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_hand_03.png` },
      { id: nextId(), name: 'MI Security Overalls T1', setName: 'MI Security', tier: 'T4', level: 70, def: 56, stats: [{ name: 'Intellect', value: '+87' }, { name: 'Will', value: '+58' }, { name: 'Crit Rate', value: '+5.2%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_criti01_body_04.png` },
    ],
  },
  {
    name: 'Pulser Labs',
    ...
    icon: `${CDN}/itemicon/item_equip_t4_suit_pulse_cryst01_body_01.png`,
    pieces: [
      { id: nextId(), name: 'Pulser Labs Disruptor Suit', setName: 'Pulser Labs', tier: 'T4', level: 70, def: 56, stats: [{ name: 'Intellect', value: '+87' }, { name: 'Will', value: '+58' }, { name: 'Arts Intensity', value: '+21' }], icon: `${CDN}/itemicon/item_equip_t4_suit_pulse_cryst01_body_01.png` },
      { id: nextId(), name: 'Pulser Labs Calibrator', setName: 'Pulser Labs', tier: 'T4', level: 70, def: 21, stats: [{ name: 'Intellect', value: '+41' }, { name: 'Arts Intensity', value: '+41' }], icon: `${CDN}/itemicon/item_equip_t4_suit_pulse_cryst01_edc_01.png` },
      { id: nextId(), name: 'Pulser Labs Gloves', setName: 'Pulser Labs', tier: 'T4', level: 70, def: 42, stats: [{ name: 'Will', value: '+65' }, { name: 'Intellect', value: '+43' }, { name: 'Cryo & Electric DMG', value: '+19.2%' }], icon: `${CDN}/itemicon/item_equip_t4_suit_pulse_cryst01_hand_01.png` },
    ],
  },
  {
    name: 'Swordmancer',
  ...
  // ============================================================
  {
    ...
    pieces: [
      ...
      { id: nextId(), name: 'Aburrey Sensor Chip', setName: "Aburrey's Legacy", tier: 'T3', level: 50, def: 15, stats: [{ name: 'Will', value: '+23' }, { name: 'Agility', value: '+15' }, { name: 'Normal Skill DMG', value: '+29.4%' }], icon: 'https://endfield.wiki.gg/images/Aburrey_Sensor_Chip.png' },
      { id: nextId(), name: 'Aburrey Sensor Chip T1', setName: "Aburrey's Legacy", tier: 'T3', level: 50, def: 15, stats: [{ name: 'Will', value: '+23' }, { name: 'Intellect', value: '+15' }, { name: 'Normal Skill DMG', value: '+29.4%' }], icon: 'https://endfield.wiki.gg/images/Aburrey_Sensor_Chip_T1.png' },
      ...
      { id: nextId(), name: 'Aburrey Light Armor', setName: "Aburrey's Legacy", tier: 'T3', level: 50, def: 40, stats: [{ name: 'Intellect', value: '+61' }, { name: 'Strength', value: '+41' }, { name: 'Ultimate SP Gain', value: '+8.8%' }], icon: 'https://endfield.wiki.gg/images/Aburrey_Light_Armor.png' },
      { id: nextId(), name: 'Aburrey Heavy Armor', setName: "Aburrey's Legacy", tier: 'T3', level: 50, def: 40, stats: [{ name: 'Strength', value: '+61' }, { name: 'Agility', value: '+41' }, { name: 'All Skill DMG', value: '+9.8%' }], icon: 'https://endfield.wiki.gg/images/Aburrey_Heavy_Armor.png' },
      { id: nextId(), name: 'Aburrey Heavy Armor T1', setName: "Aburrey's Legacy", tier: 'T3', level: 50, def: 40, stats: [{ name: 'Agility', value: '+61' }, { name: 'Strength', value: '+41' }, { name: 'Combo Skill DMG', value: '+14.7%' }], icon: 'https://endfield.wiki.gg/images/Aburrey_Heavy_Armor_T1.png' },
      { id: nextId(), name: 'Aburrey UV Lamp', setName: "Aburrey's Legacy", tier: 'T3', level: 50, def: 15, stats: [{ name: 'Strength', value: '+23' }, { name: 'Agility', value: '+15' }, { name: 'All Skill DMG', value: '+19.6%' }], icon: 'https://endfield.wiki.gg/images/Aburrey_UV_Lamp.png' },
      { id: nextId(), name: 'Aburrey Auditory Chip', setName: "Aburrey's Legacy", tier: 'T3', level: 50, def: 15, stats: [{ name: 'Strength', value: '+23' }, { name: 'Will', value: '+15' }, { name: 'DMG to Broken', value: '+29.4%' }], icon: 'https://endfield.wiki.gg/images/Aburrey_Auditory_Chip.png' },
    ],
  },
  {
    name: 'Armored MSGR',
  ...
  },
  {
    ...
    icon: `${CDN}/itemicon/item_equip_t1_suit_wisdwill01_body_01.png`,
    pieces: [
      { id: nextId(), name: 'AIC Ceramic Plate', setName: 'AIC Light', tier: 'T1', level: 28, def: 8, stats: [{ name: 'Will', value: '+16' }, { name: 'Normal Skill DMG', value: '+16.2%' }], icon: `${CDN}/itemicon/item_equip_t1_suit_wisdwill01_edc_01.png` },
      { id: nextId(), name: 'AIC Light Plate', setName: 'AIC Light', tier: 'T1', level: 28, def: 8, stats: [{ name: 'Intellect', value: '+16' }, { name: 'Combo Skill DMG', value: '+16.2%' }], icon: `${CDN}/itemicon/item_equip_t1_suit_wisdwill01_edc_02.png` },
      { id: nextId(), name: 'AIC Light Armor', setName: 'AIC Light', tier: 'T1', level: 28, def: 22, stats: [{ name: 'Intellect', value: '+30' }, { name: 'Will', value: '+30' }, { name: 'Normal Skill DMG', value: '+8.1%' }], icon: `${CDN}/itemicon/item_equip_t1_suit_wisdwill01_body_01.png` },
      { id: nextId(), name: 'AIC Tactical Gloves', setName: 'AIC Light', tier: 'T1', level: 28, def: 17, stats: [{ name: 'Intellect', value: '+23' }, { name: 'Agility', value: '+23' }, { name: 'Combo Skill DMG', value: '+13.5%' }], icon: `${CDN}/itemicon/item_equip_t1_suit_wisdwill01_hand_01.png` },
    ],
  },
];
...
export const STANDALONE_GEAR: GearPiece[] = [
  // T4 Standalone (Lv70)
  { id: nextId(), name: 'Redeemer Tag', setName: null, tier: 'T4', level: 70, def: 21, stats: [{ name: 'Strength', value: '+43' }, { name: 'All DMG Taken Reduction', value: '-17.8%' }], icon: '/equipment-icons/redeemer-tag.png' },
  { id: nextId(), name: 'Redeemer Tag T1', setName: null, tier: 'T4', level: 70, def: 21, stats: [{ name: 'Agility', value: '+43' }, { name: 'Combo Skill DMG', value: '+43.2%' }], icon: '/equipment-icons/redeemer-tag.png' },
  { id: nextId(), name: 'Redeemer Seal', setName: null, tier: 'T4', level: 70, def: 21, stats: [{ name: 'Intellect', value: '+43' }, { name: 'Ultimate SP Gain', value: '+25.7%' }], icon: '/equipment-icons/redeemer-seal.png' },
  { id: nextId(), name: 'Redeemer Seal T1', setName: null, tier: 'T4', level: 70, def: 21, stats: [{ name: 'Will', value: '+43' }, { name: 'Crit Rate', value: '+10.8%' }], icon: '/equipment-icons/redeemer-seal.png' },

  // T3 Standalone (Lv50)
  { id: nextId(), name: 'Miner Armor T1', setName: null, tier: 'T3', level: 50, def: 40, stats: [{ name: 'Strength', value: '+65' }, { name: 'Will', value: '+43' }, { name: 'Crit Rate', value: '+3.9%' }], icon: '/equipment-icons/miner-armor.png' },
  { id: nextId(), name: 'Miner Overalls T1', setName: null, tier: 'T3', level: 50, def: 40, stats: [{ name: 'Intellect', value: '+65' }, { name: 'Agility', value: '+43' }, { name: 'ATK', value: '+7.8%' }], icon: '/equipment-icons/miner-overalls.png' },
  { id: nextId(), name: 'Miner Turbine T1', setName: null, tier: 'T3', level: 50, def: 15, stats: [{ name: 'Strength', value: '+31' }, { name: 'All DMG Taken Reduction', value: '-13.5%' }], icon: '/equipment-icons/miner-turbine.png' },
  { id: nextId(), name: 'Miner Compression Core T1', setName: null, tier: 'T3', level: 50, def: 15, stats: [{ name: 'Agility', value: '+31' }, { name: 'Combo Skill DMG', value: '+31.2%' }], icon: '/equipment-icons/miner-compression-core.png' },
  { id: nextId(), name: 'Miner Drive Wheel T1', setName: null, tier: 'T3', level: 50, def: 15, stats: [{ name: 'Intellect', value: '+31' }, { name: 'Ultimate SP Gain', value: '+18.6%' }], icon: '/equipment-icons/miner-drive-wheel.png' },
  { id: nextId(), name: 'Miner Comm T1', setName: null, tier: 'T3', level: 50, def: 15, stats: [{ name: 'Will', value: '+31' }, { name: 'Heal Output', value: '+15.6%' }], icon: '/equipment-icons/miner-comm.png' },
  { id: nextId(), name: 'Miner Gloves T2', setName: null, tier: 'T3', level: 50, def: 30, stats: [{ name: 'Intellect', value: '+49' }, { name: 'Agility', value: '+32' }, { name: 'ATK', value: '+13.0%' }], icon: '/equipment-icons/miner-gloves.png' },
  { id: nextId(), name: 'Miner Fists T1', setName: null, tier: 'T3', level: 50, def: 30, stats: [{ name: 'Will', value: '+49' }, { name: 'Intellect', value: '+32' }, { name: 'Ultimate SP Gain', value: '+15.5%' }], icon: '/equipment-icons/miner-fists.png' },

  // T2 Standalone (Lv36)
  { id: nextId(), name: 'Miner Turbine', setName: null, tier: 'T2', level: 36, def: 11, stats: [{ name: 'Strength', value: '+22' }, { name: 'Combo Skill DMG', value: '+22.8%' }], icon: '/equipment-icons/miner-turbine.png' },
  { id: nextId(), name: 'Miner Drive Wheel', setName: null, tier: 'T2', level: 36, def: 11, stats: [{ name: 'Agility', value: '+22' }, { name: 'Crit Rate', value: '+5.7%' }], icon: '/equipment-icons/miner-drive-wheel.png' },
  { id: nextId(), name: 'Miner Compression Core', setName: null, tier: 'T2', level: 36, def: 11, stats: [{ name: 'Intellect', value: '+22' }, { name: 'Crit Rate', value: '+5.7%' }], icon: '/equipment-icons/miner-compression-core.png' },
  { id: nextId(), name: 'Miner Comm', setName: null, tier: 'T2', level: 36, def: 11, stats: [{ name: 'Will', value: '+22' }, { name: 'HP', value: '+22.8%' }], icon: '/equipment-icons/miner-comm.png' },
  { id: nextId(), name: 'Miner Gauntlets T1', setName: null, tier: 'T2', level: 36, def: 22, stats: [{ name: 'Strength', value: '+36' }, { name: 'Intellect', value: '+24' }, { name: 'ATK', value: '+9.5%' }], icon: '/equipment-icons/miner-gauntlets.png' },
  { id: nextId(), name: 'Miner Gloves T1', setName: null, tier: 'T2', level: 36, def: 22, stats: [{ name: 'Intellect', value: '+36' }, { name: 'Agility', value: '+24' }, { name: 'HP', value: '+19.0%' }], icon: '/equipment-icons/miner-gloves.png' },

  // T1 Standalone (Lv10-28)
  { id: nextId(), name: 'Miner Armor', setName: null, tier: 'T1', level: 20, def: 16, stats: [{ name: 'Strength', value: '+27' }, { name: 'Agility', value: '+18' }, { name: 'HP', value: '+125.4%' }], icon: '/equipment-icons/miner-armor.png' },
  { id: nextId(), name: 'Miner Overalls', setName: null, tier: 'T1', level: 20, def: 16, stats: [{ name: 'Intellect', value: '+27' }, { name: 'Will', value: '+18' }, { name: 'HP', value: '+125.4%' }], icon: '/equipment-icons/miner-overalls.png' },
  { id: nextId(), name: 'Prototype Heavy Armor', setName: null, tier: 'T1', level: 28, def: 22, stats: [{ name: 'Strength', value: '+37' }, { name: 'Intellect', value: '+25' }, { name: 'ATK', value: '+11.7%' }], icon: '/equipment-icons/prototype-heavy-armor.png' },
  { id: nextId(), name: 'Prototype Heavy Armor T1', setName: null, tier: 'T1', level: 28, def: 22, stats: [{ name: 'Agility', value: '+37' }, { name: 'Will', value: '+25' }, { name: 'ATK', value: '+11.7%' }], icon: '/equipment-icons/prototype-heavy-armor.png' },
  { id: nextId(), name: 'Miner Vest', setName: null, tier: 'T1', level: 28, def: 22, stats: [{ name: 'Agility', value: '+37' }, { name: 'Intellect', value: '+25' }, { name: 'HP', value: '+9.0%' }], icon: '/equipment-icons/miner-vest.png' },
  { id: nextId(), name: 'Miner Cleansuit', setName: null, tier: 'T1', level: 28, def: 22, stats: [{ name: 'Will', value: '+37' }, { name: 'Agility', value: '+25' }, { name: 'HP', value: '+9.0%' }], icon: '/equipment-icons/miner-cleansuit.png' },
  { id: nextId(), name: 'Emergency Comm', setName: null, tier: 'T1', level: 20, def: 6, stats: [{ name: 'Crit Rate', value: '+6.6%' }], icon: '/equipment-icons/emergency-comm.png' },
  { id: nextId(), name: 'Emergency Compression Core', setName: null, tier: 'T1', level: 20, def: 6, stats: [{ name: 'ATK', value: '+13.2%' }], icon: '/equipment-icons/emergency-compression-core.png' },
  { id: nextId(), name: 'Miner Gauntlets', setName: null, tier: 'T1', level: 20, def: 12, stats: [{ name: 'Strength', value: '+20' }, { name: 'Agility', value: '+13' }, { name: 'HP', value: '+11.0%' }], icon: '/equipment-icons/miner-gauntlets.png' },
  { id: nextId(), name: 'Miner Wrists', setName: null, tier: 'T1', level: 28, def: 17, stats: [{ name: 'Agility', value: '+28' }, { name: 'Strength', value: '+18' }, { name: 'HP', value: '+15.0%' }], icon: '/equipment-icons/miner-wrists.png' },
  { id: nextId(), name: 'Miner Gloves', setName: null, tier: 'T1', level: 20, def: 12, stats: [{ name: 'Intellect', value: '+20' }, { name: 'Will', value: '+13' }, { name: 'HP', value: '+11.0%' }], icon: '/equipment-icons/miner-gloves.png' },
  { id: nextId(), name: 'Miner Fists', setName: null, tier: 'T1', level: 28, def: 17, stats: [{ name: 'Will', value: '+28' }, { name: 'Intellect', value: '+18' }, { name: 'HP', value: '+15.0%' }], icon: '/equipment-icons/miner-fists.png' },

  // T0 Starter
  { id: nextId(), name: 'Basic Armor', setName: null, tier: 'T0', level: 10, def: 8, stats: [{ name: 'Strength', value: '+15' }, { name: 'Agility', value: '+10' }, { name: 'HP', value: '+46.3%' }], icon: '/equipment-icons/basic-armor.png' },
  { id: nextId(), name: 'Basic PPE', setName: null, tier: 'T0', level: 10, def: 8, stats: [{ name: 'Intellect', value: '+15' }, { name: 'Will', value: '+10' }, { name: 'HP', value: '+46.3%' }], icon: '/equipment-icons/basic-ppe.png' },
  { id: nextId(), name: 'Basic Gauntlets', setName: null, tier: 'T0', level: 10, def: 6, stats: [{ name: 'Strength', value: '+11' }, { name: 'Agility', value: '+7' }, { name: 'HP', value: '+77.2%' }], icon: '/equipment-icons/basic-gauntlets.png' },
  { id: nextId(), name: 'Basic Gloves', setName: null, tier: 'T0', level: 10, def: 6, stats: [{ name: 'Intellect', value: '+11' }, { name: 'Will', value: '+7' }, { name: 'HP', value: '+77.2%' }], icon: '/equipment-icons/basic-gloves.png' },
];
