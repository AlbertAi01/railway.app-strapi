...
export const OPERATOR_GUIDES: Record<string, OperatorGuide> = {
  ...
  'ardelia': {
    ...
    bestWeapons: [
      { name: 'Delivery Guaranteed', rating: 5, notes: 'Best in slot - maximizes healing output and support utility' },
      { name: 'Dreams of the Starry Beach', rating: 4, notes: 'Strong alternative with good passive bonuses' },
      { name: 'Oblivion', rating: 3, notes: 'Decent option if signature weapons are unavailable' },
      { name: 'OBJ Arts Identifier', rating: 3, notes: 'Budget 5-star option with solid stats' },
    ],
    bestGearSets: ['LYNX', 'Catastrophe'],
  ...
  'ember': {
    ...
    bestWeapons: [
      { name: 'Exemplar', rating: 5, notes: 'Best defensive weapon for tank builds' },
      { name: 'Thunderberge', rating: 4, notes: 'Good balance of offense and defense' },
      { name: 'Industry 0.1', rating: 3, notes: 'Accessible 4-star option' },
    ],
    bestGearSets: ['Æthertech', 'AIC Heavy'],
    skillPriority: 'Combo Skill > Ultimate > Battle Skill > Basic Attack',
  ...
  'endministrator': {
    ...
    bestWeapons: [
      { name: 'Forgeborn Scathe', rating: 5, notes: 'Signature weapon with best stat alignment' },
      { name: 'Rapid Ascent', rating: 4, notes: 'Strong alternative with Agility focus' },
      { name: 'Contingent Measure', rating: 3, notes: 'Solid 4-star fallback option' },
    ],
  ...
  'gilberta': {
    ...
    bestWeapons: [
      { name: 'Opus: Etch Figure', rating: 5, notes: 'Best in slot for support builds' },
      { name: 'Chivalric Virtues', rating: 4, notes: 'Good alternative with defensive utility' },
  ...
  'laevatain': {
    ...
    bestWeapons: [
      { name: 'Umbral Torch', rating: 5, notes: 'Signature weapon - best damage scaling' },
      { name: 'Thermite Cutter', rating: 4, notes: 'Strong Heat-synergy alternative' },
      { name: 'Sundering Steel', rating: 3, notes: '5-star option with good base stats' },
    ],
  ...
  'pogranichnik': {
    ...
    bestWeapons: [
      { name: 'Eminent Repute', rating: 5, notes: 'Best sword for Vanguard support builds' },
      { name: 'White Night Nova', rating: 4, notes: 'Strong SP generation synergy' },
      { name: 'Fortmaker', rating: 3, notes: '5-star with good support utility' },
    ],
    bestGearSets: ['Æthertech', 'Swordmancer'],
    skillPriority: 'Battle Skill > Combo Skill > Ultimate > Basic Attack',
  ...
  'yvonne': {
    ...
    bestWeapons: [
      { name: 'Artzy Tyrannical', rating: 5, notes: 'Signature handcannon - unmatched DPS' },
      { name: 'Clannibal', rating: 4, notes: 'Strong alternative with good Cryo synergy' },
      { name: 'Rational Farewell', rating: 3, notes: '5-star option with solid damage' },
    ],
    bestGearSets: ['Tide Surge', 'Type 50 Yinglung'],
  ...
  'alesh': {
    ...
    bestWeapons: [
      { name: 'Aspirant', rating: 4, notes: 'Good 5-star sword for Cryo Vanguards' },
      { name: 'Twelve Questions', rating: 3, notes: 'Alternative with balanced stats' },
      { name: 'Contingent Measure', rating: 2, notes: '4-star budget option' },
    ],
    bestGearSets: ['Swordmancer', 'AIC Heavy'],
    skillPriority: 'Battle Skill > Combo Skill > Ultimate > Basic Attack',
  ...
  'chen-qianyu': {
    ...
    bestWeapons: [
      { name: 'Sundering Steel', rating: 4, notes: 'Best 5-star sword for Physical Guards' },
      { name: 'Fortmaker', rating: 4, notes: 'Strong alternative with defensive passive' },
      { name: 'Contingent Measure', rating: 3, notes: '4-star option with solid stats' },
    ],
    bestGearSets: ['Swordmancer', 'Type 50 Yinglung'],
    skillPriority: 'Battle Skill > Combo Skill > Ultimate > Basic Attack',
  ...
  'perlica': {
    ...
    bestWeapons: [
      { name: 'Stanza of Memorials', rating: 4, notes: 'Best 5-star Arts Unit for Casters' },
      { name: 'Monaihe', rating: 3, notes: 'Good alternative with support utility' },
      { name: 'Hypernova Auto', rating: 2, notes: '4-star budget option' },
    ],
    bestGearSets: ['Mordvolt Insulation', 'Eternal Xiranite'],
    skillPriority: 'Battle Skill > Combo Skill > Ultimate > Basic Attack',
  ...
  'snowshine': {
    ...
    bestWeapons: [
      { name: 'Seeker of Dark Lung', rating: 4, notes: 'Best 5-star greatsword for Cryo Defenders' },
      { name: 'OBJ Heavy Burden', rating: 3, notes: 'Defensive alternative' },
      { name: 'Quencher', rating: 2, notes: '4-star budget option' },
    ],
    bestGearSets: ['Æthertech', 'Mordvolt Resistant'],
    skillPriority: 'Combo Skill > Battle Skill > Ultimate > Basic Attack',
