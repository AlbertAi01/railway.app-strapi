                ...
                <div className="relative">
                  ...
                  {showShareMenu && character && (
                    <div className="absolute right-0 top-full mt-2 w-48 bg-[var(--color-surface)] border border-[var(--color-border)] clip-corner-tl shadow-xl z-50 overflow-hidden">
                      ...
                      <button onClick={shareToDiscord} className="w-full px-4 py-3 text-left text-sm hover:bg-[var(--color-surface-2)] flex items-center gap-3 text-gray-300">
                      ...
                      <button onClick={copyToClipboard} className="w-full px-4 py-3 text-left text-sm hover:bg-[var(--color-surface-2)] flex items-center gap-3 text-gray-300 border-t border-[var(--color-border)]">
                      ...
                      {typeof navigator !== 'undefined' && 'share' in navigator && (
                        <button onClick={nativeShare} className="w-full px-4 py-3 text-left text-sm hover:bg-[var(--color-surface-2)] flex items-center gap-3 text-gray-300 border-t border-[var(--color-border)]">
                          <Share2 className="w-4 h-4" />
                          More Options...
                        </button>
                      )}
