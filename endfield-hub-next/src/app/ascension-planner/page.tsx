...
export default function AscensionPlannerPage() {
  ...
  const [targetLevel, setTargetLevel] = useState('E2 90');
  ...
  const calculateMaterials = () => {
    ...
    // Add promotion materials
    if (targetLevel.includes('E1') || targetLevel.includes('E2')) {
      ASCENSION_MATERIALS.E1.forEach(mat => {
        materials[mat.item] = (materials[mat.item] || 0) + mat.amount;
      });
    }
    if (targetLevel.includes('E2')) {
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    <option value="E1 70">E1 70</option>
                    <option value="E2 1">E2 1</option>
                    <option value="E2 90">E2 90</option>
                  </select>
                </div>
              </div>
